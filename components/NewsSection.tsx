...
export const NewsSection: React.FC = () => {
  const newsItems = [
    ...
    },
    {
      ...
      date: "Есымша",
      year: "2026",
      title: "Ашколхәыҷқәеи астудентцәеи рзы аекскурсиақәа",
      desc: "Аԥсны араионқәа зегьы рҟынтә ашколхәыҷқәа аҩны-музеи ахь аекскурсиақәа рзы дрыдыркылоит. Аклассик иԥсҭазаара аҭоурых аарԥшуп.",
      category: "Аекскурсиақәа",
      location: "Аҩны-музеи",
    },
    {
      id: 3,
